...
public class Ping extends AbstractApplication {
	private static final String APPLICATION = "ping";
	private static final int APPLICATION_NUMBER = 2;
	...
	private List<String> board = Arrays.asList("RSKRX65N-2MB","CloudKitRX65N","CK-RX65N", "EnvisionKitRX72N", "RSKRX671");
